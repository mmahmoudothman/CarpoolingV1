package com.example.mahmoud.carpoolingv1.adapter;
...
import com.example.mahmoud.carpoolingv1.adapter.base.BaseAdapter;
        ...
        void onCopyButtonClick() {
            if (textPhone != null && imagePhoto != null && imagePhoto.getContext() != null) {
                ...
                if (!StringUtils.isEmpty(currentPhone)) {
                    ...
                    ClipData clip = ClipData.newPlainText("هاتف", textPhone.getText());
                    clipboard.setPrimaryClip(clip);
                    Toast.makeText(imagePhoto.getContext(), "الهاتف المنسوخ: " + textPhone.getText(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(imagePhoto.getContext(), "لا يوجد هاتف متاح", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
